...
''' 
    I am unable to test: 
    #def test_registration_form_redirects_if_valid(self):
    #def test_login_form_redirects_if_valid(self):
''' 
class TestCustomerFeatures(MockDB, BaseTestCase):
    ...
    def test_registration_form_returns_form_errors_if_invalid(self):
    ...
    def test_profile_page_doesnt_load_if_not_logged_in(self):
